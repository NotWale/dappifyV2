...
export default function ConnectButton({
  ...
  return isConnected ? (
    <div className="fixed z-50 flex flex-row-reverse h-14 w-full py-2 pr-2 bg-gray-900">
      <button
        className="flex h-9 items-center border border-solid border-transparent bg-gray-700 rounded-xl text-base font-medium text-white cursor-pointer hover:border-blue-400"
      ...
      >
        ...
        <h6 className="flex h-full pt-1 ml-2 px-2 border border-gray-800 bg-gray-800 rounded-xl">
